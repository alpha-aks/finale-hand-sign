    ...
    while True:
        ...
        if results.hand_landmarks:
            for hand_landmarks, handedness in zip(results.hand_landmarks, results.handedness):
                ...
                landmark_list_normalized = [[lm.x, lm.y] for lm in hand_landmarks]
                ...
                now = time.time()
                if (hand_sign_text
                        and hand_sign_text != last_spoken_text
                        and (now - last_spoken_time) >= 1.0):
                    speaker.say(hand_sign_text)
                    last_spoken_text = hand_sign_text
